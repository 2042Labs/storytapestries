    ...
    <div class="para-settings team-settings">
		...
		<ul class="box">
			...
			<div class="option-box">
				<p class="option-title"><?php _e('Display input field on team member profile.','team'); ?></p>
			...
			<table class="team_member_social_field" id="team_member_social_field">
                    ...
                    if($team_customer_type=="free")
                        {
                            ...
                            echo 'You are using <strong> '.$team_customer_type.' version  '.$team_version['current'].'</strong> of <strong>'.team_plugin_name.'</strong>, To get more feature you could try our premium version. ';
                    ...
                    else
                        {
                            ...
                            echo 'Thanks for using <strong> premium version  '.$team_version['current'].'</strong> of <strong>'.team_plugin_name.'</strong> ';	
