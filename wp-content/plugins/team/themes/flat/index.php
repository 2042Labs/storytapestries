...
function team_body_flat($post_id)
	{
		...
		$team_body .= '<div  class="team-container" style="background-image:url('.$team_bg_img.');text-align:'.$team_grid_item_align.';">
		...
		if($team_items_link_to_post == 'yes')
			...
			$team_body.= '<div class="team-social '.$team_social_icon_style.'" >';
